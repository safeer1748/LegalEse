...
const Profile_Settings = () => {
  ...
  const handleSubmit = async(e) => {
    ...
    if (formData.profile.mobile === "" || formData.profile.mobile === null) {
      ...
      !/^03\d{9}$/.test(formData.profile.mobile)
    ) {
      isValid = false;
    ...
    if (formData.profile.address === "" || formData.profile.address === null) {
     ...
     // mobile number Validation
     if (formData.profile.location_url === "" || formData.profile.location_url === null) {
      isValid = false;
    ...
    if (Object.keys(validationErrors).length === 0) {
      await axios
        .put("http://localhost:8000/users/" + formData.id, formData)
        .then((res) => {
            ...
            <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                >
                  <legend className="block text-sm font-medium text-gray-900 dark:text-white">
                    ...
                    <label className="block mb-2 font-normal text-sm text-gray-400 dark:text-white">
                      Client will not be able to book appoinment if you are not available
                    </label>
                  </legend>
              ...
              <div className="w-full">
                ...
                <input
                  ...
                  onChange={(e)=>setFormData({...formData,profile:{ ...formData.profile,mobile:e.target.value}})}
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                />
                <div className="text-red-600">
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  ...
                  onChange={(e)=>setFormData({...formData,profile:{ ...formData.profile,about:e.target.value}})}
                ></textarea>
                <div className="text-red-600">
              ...
              <div className="sm:col-span-2">
                <Specialization formData={formData} setFormData={setFormData}/>
                <div className="text-red-600">
              ...
              <div className="sm:col-span-2">
                ...
                <label className="block mb-2 text-sm text-gray-400 dark:text-white">
                  Make sure to put your office address because other will see
                  it.
                </label>
                <input
                  type="text"
              ...
              <div className="sm:col-span-2">
                ...
                <label className="block mb-2 text-sm text-gray-400 dark:text-white">
                  Make sure to put your office google map location url because other will see
                  it.
                </label>
                <input
                  type="text"
                  ...
                  onChange={(e)=>setFormData({...formData,profile:{ ...formData.profile,location_url:e.target.value}})}
