                      ...
                      <tr className="border-b  border-gray-300 align-top">
                        ...
                        >
                          ...
                          <div className="font-normal text-gray-500">
                            <p>case no: <span className="font-medium">032145</span></p>
                            <p>case type : <span className="font-medium">murder</span></p>
                            <p>defendant: <span className="font-medium">zubair khan</span></p>
                            <p>defendant lawyer: <span className="font-medium">Muhammad umair</span></p>
                          </div>
                        </th>
                        <td className="px-4 py-3 whitespace-nowrap">
                        <div className="font-normal text-gray-500">
                            <p>court: <span className="font-medium">high court taxila</span></p>
                            <p>court no : <span className="font-medium">12234567</span></p>
                            <p>judge: <span className="font-medium">Haris awan</span></p>
                          </div>
                        </td>
                        <td className="px-4 py-3">2/24/2024</td>
                        <td
                          className="px-4 py-3 cursor-pointer "
                          onClick={handleStatus}
                        >
                            {status} <RiExpandUpDownFill className="inline"/>
